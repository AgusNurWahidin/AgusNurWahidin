  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li><a href="<?php echo site_url('Bayar/utama1'); ?>">Home</a></li>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Futsal</a></h4>
              <img src="<?php echo base_url('assets/img/futsal.jpeg') ?>" class="user-image" alt="User Image" width="200">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Lomba bakiak</a></h4>
              <img src="<?php echo base_url('assets/img/lomba.jpeg') ?>" class="user-image" alt="User Image" width="200">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Balap Dayung Perahu</a></h4>
              <img src="<?php echo base_url('assets/img/sungai.jpeg') ?>" class="user-image" alt="User Image" width="200">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Lomba 17 Agustus</a></h4>
              <img src="<?php echo base_url('assets/img/finis.jpeg') ?>" class="user-image" alt="User Image" width="200">
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">kesenian bantengan</a></h4>
              <img src="<?php echo base_url('assets/img/banteng.jpeg') ?>" class="user-image" alt="User Image" width="200">
            </div>
          </div>
          ...
          <!-- <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <img src="<?php echo base_url('assets/img/blog-2.jpg') ?>" class="user-image" alt="User Image" width="200">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <img src="<?php echo base_url('assets/img/blog-3.jpg') ?>" class="user-image" alt="User Image" width="200">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <img src="<?php echo base_url('assets/img/blog-4.jpg') ?>" class="user-image" alt="User Image" width="200">
            </div>
          </div> -->
